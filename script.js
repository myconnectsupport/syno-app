...
function saveState() {
    ...
    const fullData = {
        ...
        background: backgroundImageData, // <--- NOUVEAU
        bgOpacity: backgroundOpacity,     // <--- NOUVEAU
        bgWidth: bgWidth,      // <--- NOUVEAU
        bgHeight: bgHeight     // <--- NOUVEAU
    };
...
function restoreState(stateStr) {
    ...
    try {
        ...
        if (Array.isArray(data)) {
            ...
            // --- RECHARGE LE FOND ET SA TAILLE ---
            if (data.background !== undefined) {
                backgroundImageData = data.background;
                backgroundOpacity = data.bgOpacity !== undefined ? data.bgOpacity : 0.5;
                bgWidth = data.bgWidth || null;   // <--- NOUVEAU
                bgHeight = data.bgHeight || null; // <--- NOUVEAU
...
const presetsByType = {
  bullet: {
    names: ["CAM1", "CAM2", "CAM3", "CAM4", "CAM5", "CAM6", "CAM7", "CAM8", "CAM9", "CAM10", "CAM11", "CAM12", "CAM13", "CAM14", "CAM15", "CAM16", "CAM17", "CAM18", "CAM19", "CAM20", "CAM21", "CAM22", "CAM23", "CAM24", "CAM25", "CAM26", "CAM27", "CAM28", "CAM29", "CAM30", "CAM31", "CAM32", "CAM33", "CAM34", "CAM35", "CAM36", "CAM37", "CAM38", "CAM39", "CAM40", "CAM41", "CAM42", "CAM43", "CAM44", "CAM45", "CAM46", "CAM47", "CAM48", "CAM49", "CAM50"],
    ips: ["172.16.0.101", "172.16.0.102", "172.16.0.103", "172.16.0.104", "172.16.0.105", "172.16.0.106", "172.16.0.107", "172.16.0.108", "172.16.0.109", "172.16.0.110", "172.16.0.111", "172.16.0.112", "172.16.0.113", "172.16.0.114", "172.16.0.115", "172.16.0.116", "172.16.0.117", "172.16.0.118", "172.16.0.119", "172.16.0.120", "172.16.0.121", "172.16.0.122", "172.16.0.123", "172.16.0.124", "172.16.0.125", "172.16.0.126", "172.16.0.127", "172.16.0.128", "172.16.0.129", "172.16.0.130", "172.16.0.131", "172.16.0.132", "172.16.0.133", "172.16.0.134", "172.16.0.135", "172.16.0.136", "172.16.0.137", "172.16.0.138", "172.16.0.139", "172.16.0.140", "172.16.0.141", "172.16.0.142", "172.16.0.143", "172.16.0.144", "172.16.0.145", "172.16.0.146", "172.16.0.147", "172.16.0.148", "172.16.0.149", "172.16.0.150"]
  },
  dome: {
    names: ["CAM1", "CAM2", "CAM3", "CAM4", "CAM5", "CAM6", "CAM7", "CAM8", "CAM9", "CAM10", "CAM11", "CAM12", "CAM13", "CAM14", "CAM15", "CAM16", "CAM17", "CAM18", "CAM19", "CAM20", "CAM21", "CAM22", "CAM23", "CAM24", "CAM25", "CAM26", "CAM27", "CAM28", "CAM29", "CAM30", "CAM31", "CAM32", "CAM33", "CAM34", "CAM35", "CAM36", "CAM37", "CAM38", "CAM39", "CAM40", "CAM41", "CAM42", "CAM43", "CAM44", "CAM45", "CAM46", "CAM47", "CAM48", "CAM49", "CAM50"],
    ips: ["172.16.0.101", "172.16.0.102", "172.16.0.103", "172.16.0.104", "172.16.0.105", "172.16.0.106", "172.16.0.107", "172.16.0.108", "172.16.0.109", "172.16.0.110", "172.16.0.111", "172.16.0.112", "172.16.0.113", "172.16.0.114", "172.16.0.115", "172.16.0.116", "172.16.0.117", "172.16.0.118", "172.16.0.119", "172.16.0.120", "172.16.0.121", "172.16.0.122", "172.16.0.123", "172.16.0.124", "172.16.0.125", "172.16.0.126", "172.16.0.127", "172.16.0.128", "172.16.0.129", "172.16.0.130", "172.16.0.131", "172.16.0.132", "172.16.0.133", "172.16.0.134", "172.16.0.135", "172.16.0.136", "172.16.0.137", "172.16.0.138", "172.16.0.139", "172.16.0.140", "172.16.0.141", "172.16.0.142", "172.16.0.143", "172.16.0.144", "172.16.0.145", "172.16.0.146", "172.16.0.147", "172.16.0.148", "172.16.0.149", "172.16.0.150"]
  ...
  switch: {
    names: ["SWITCH1", "SWITCH2", "SWITCH3", "SWITCH4", "SWITCH5", "SWITCH6", "SWITCH7", "SWITCH8", "SWITCH9", "SWITCH10", "SWITCH11", "SWITCH12", "SWITCH13", "SWITCH14", "SWITCH15", "SWITCH16", "SWITCH17", "SWITCH18", "SWITCH19", "SWITCH20"],
    ips: ["172.16.0.200", "172.16.0.201", "172.16.0.202", "172.16.0.203", "172.16.0.204", "172.16.0.205", "172.16.0.206", "172.16.0.207", "172.16.0.208", "172.16.0.209", "172.16.0.210", "172.16.0.211", "172.16.0.212", "172.16.0.213", "172.16.0.214", "172.16.0.215", "172.16.0.216", "172.16.0.217", "172.16.0.218", "172.16.0.219"]
  },
  nvr: {
  ...
  nxwitness: {
    names: ["SERVEUR-NX-1", "SERVEUR-NX-2", "SERVEUR-NX-3", "SERVEUR-NX-4"],
    ips: ["172.16.1.1", "172.16.1.2", "172.16.1.3", "172.16.1.4"]
  },
  ampli: {
    names: ["AMPLI1", "AMPLI2", "AMPLI3", "AMPLI4", "AMPLI5", "AMPLI6", "AMPLI7", "AMPLI8", "AMPLI9", "AMPLI10", "AMPLI11", "AMPLI12", "AMPLI13", "AMPLI14", "AMPLI15"],
    ips: ["172.16.0.51", "172.16.0.52", "172.16.0.53", "172.16.0.54", "172.16.0.55", "172.16.0.56", "172.16.0.57", "172.16.0.58", "172.16.0.59", "172.16.0.60", "172.16.0.61", "172.16.0.62", "172.16.0.63", "172.16.0.64", "172.16.0.65"]
  },
  routeur: {
...
function render() {
  ...
  equipments.forEach((eq) => {
    ...
    // --- NOUVEAU : Préparation du badge ColorVu ---
    // S'affiche en petit, en rouge, seulement si la case a été cochée
    const colorVuBadge = eq.isColorVu ? `<div style="font-size: 10px; color: #d9534f; font-weight: bold; margin-top: 2px;">🌈 ColorVu</div>` : "";
    // ----------------------------------------------

    // On injecte ${colorVuBadge} juste sous la localisation
    div.innerHTML = `
    ...
    div.addEventListener("dblclick", (e) => {
      if (!e.target.closest(".photo-section")) { 
          e.stopPropagation(); 
          openEditModal(eq.id); 
      }
    });
...
/* ==========================================================================
   ...
   ========================================================================== */
/* ==========================================================================
   GESTION DES LIENS FLUIDE (AVEC AUTO-INVERSION INTELLIGENTE)
   ========================================================================== */
/* ==========================================================================
   GESTION DES LIENS FLUIDE (AVEC AUTO-INVERSION EXTRÊME)
   ========================================================================== */
function finishLinkCreation(sourceId, sourcePort, targetId, targetPort) {
    ...
    // Variables let (et non const) car on va peut-être les inverser
    let sourceEq = equipments.find(e => e.id === sourceId);
    let targetEq = equipments.find(e => e.id === targetId);

    if (!sourceEq || !targetEq) return;

    // ============================================================
    // 🧠 CERVEAU D'AUTO-INVERSION (Pour éviter d'effacer les liens)
    // ============================================================
    let shouldInvert = false;

    const parentTypes = ["routeur", "switch", "nvr", "box"];
    const childTypes = ["bullet", "dome", "ecran", "ampli", "hp", "pupitre"];

    // Règle 1 : La cible est un gros équipement et la source un petit
    if (parentTypes.includes(targetEq.type) && childTypes.includes(sourceEq.type)) {
        shouldInvert = true;
    }
    // Règle 2 : La cible a déjà des enfants (c'est donc un hub central)
    else if (equipments.some(e => e.parent === targetEq.id)) {
        shouldInvert = true;
    }
    // Règle 3 (Celle qui corrige votre bug) : La cible a DÉJÀ un parent !
    // Puisqu'elle ne peut pas avoir deux parents, on DOIT inverser le sens du
    // 2ème câble pour qu'il devienne son enfant, et ainsi ne pas effacer le premier.
    else if (targetEq.parent && targetEq.parent !== sourceId) {
        shouldInvert = true;
    }

    // Application de l'inversion si l'une des règles est validée
    if (shouldInvert) {
        let tempEq = sourceEq; sourceEq = targetEq; targetEq = tempEq;
        let tempId = sourceId; sourceId = targetId; targetId = tempId;
        let tempPort = sourcePort; sourcePort = targetPort; targetPort = tempPort;
    }
    // ============================================================

    // --- SÉCURITÉ : GESTION DES PORTS OCCUPÉS ---
    const occupierSource = getEquipmentOnPort(sourceId, sourcePort);
    if (occupierSource && occupierSource.eq.id !== targetEq.id) {
        if (occupierSource.type === 'source') {
            // On débranche poliment l'ancien enfant de ce port
            occupierSource.eq.parent = null;
            delete occupierSource.eq.sourcePort;
            delete occupierSource.eq.waypoints;
            showToast(`⚠️ Câble débranché de ${occupierSource.eq.deviceName}`);
        }
    }
    ...
    // Tracé intelligent avec évitement d'obstacles
    ...
    // Style par défaut si inexistant
    if (!targetEq.connectionStyle) {
        targetEq.connectionStyle = { type: "ethernet", color: "#007AFF", width: 2, dasharray: "" };
    }
...
function openEditModal(id) {
  ...
  // --- MODIFICATION COLORVU : On coche la case si l'option était activée ---
  const colorVuCheckbox = document.getElementById("isColorVu");
  if (colorVuCheckbox) {
      colorVuCheckbox.checked = eq.isColorVu === true;
  }
  // ------------------------------------------------------------------------
...
function updateRadioFields(currentName = "", currentIP = "") {
  ...
  if (mode === "couple") {
    ...
    document.getElementById("newLocationPR").placeholder = "Lieu Appareil";
...
function renderRadioSelects(data, nameVal, ipVal) {
  ...
  data.names.forEach((name, index) => {
    ...
    const isUsed = equipments.some(eq => eq.deviceName === name && eq.id !== editingEquipmentId);
    const disabledAttr = isUsed ? "disabled style='color: #aaa; background: #f5f5f5;'" : "";
    const label = isUsed ? `${name} (Déjà pris)` : name;

    nameHtml += `<option value="${name}" data-ip="${data.ips[index]}" ${selected} ${disabledAttr}>${label}</option>`;
  });
  ...
  data.ips.forEach((ip) => {
    ...
    const isUsedIp = equipments.some(eq => eq.ip === ip && eq.id !== editingEquipmentId);
    const disabledAttrIp = isUsedIp ? "disabled style='color: #aaa; background: #f5f5f5;'" : "";
    const labelIp = isUsedIp ? `${ip} (Prise)` : ip;

    ipHtml += `<option value="${ip}" ${selected} ${disabledAttrIp}>${labelIp}</option>`;
  });
...
/* ==========================================================================
   AFFICHAGE DES LISTES DÉROULANTES (Avec blocage des doublons)
   ========================================================================== */
function renderSelects(type, nameVal, ipVal) {
  ...
  presets.names.forEach((name, index) => {
    ...
    // Vérifier si le nom est déjà pris (en ignorant l'équipement en cours de modification)
    const isUsed = equipments.some(eq => eq.deviceName === name && eq.id !== editingEquipmentId);
    
    // Style grisé si utilisé
    const disabledAttr = isUsed ? "disabled style='color: #aaa; background: #f5f5f5;'" : "";
    const label = isUsed ? `${name} (Déjà pris)` : name;
    
    nameHtml += `<option value="${name}" data-index="${index}" ${selected} ${disabledAttr}>${label}</option>`;
  });
  nameHtml += `<option value="__manual__">Saisie manuelle...</option></select>`;
  document.getElementById("nameFieldContainer").innerHTML = nameHtml;
  ...
  presets.ips.forEach((ip) => {
    ...
    // Vérifier si l'IP est déjà prise
    const isUsedIp = equipments.some(eq => eq.ip === ip && eq.id !== editingEquipmentId);
  ...
  // === AJOUTER CECI À LA FIN DE LA FONCTION ===
  const colorVuContainer = document.getElementById("colorVuContainer");
  if (colorVuContainer) {
      if (type === "bullet" || type === "dome") {
          colorVuContainer.style.display = "block";
      } else {
          colorVuContainer.style.display = "none";
          document.getElementById("isColorVu").checked = false; // On décoche par sécurité
      }
  }
}
...
function addEquipment() {
  ...
  // --- NOUVEAU : Récupération de l'état de la case ColorVu ---
  const colorVuCheckbox = document.getElementById("isColorVu");
  const isColorVu = colorVuCheckbox ? colorVuCheckbox.checked : false;
  ...
  // --- CAS 2 : AJOUT ---
    ...
    // --- SOUS-CAS 2C : GESTION MULTI-RANGÉES (Connexion par le BAS) ---
      ...
      // ... (Reste du code Ajout Unique inchangé) ...
          ...
          // 1. Création de l'équipement AVEC isColorVu !
          const newId = addSingleNode(type, deviceName, ip, locPE, parent, safeX, scrollY, isColorVu);
...
function addSingleNode(type, name, ip, loc, parent, x, y, isColorVu = false) {
  const newId = "eq-" + Date.now() + Math.random().toString(36).substr(2, 5);
  equipments.push({ 
      id: newId, 
      type: type, 
      ...
      x: x, 
      y: y,
      isColorVu: isColorVu // <-- Le secret est ici !
  });
  return newId;
}
...
/* ==========================================================================
   GESTION DU FOND DE PLAN (CARTE AVEC REDIMENSIONNEMENT)
   ========================================================================== */
let backgroundImageData = null; 
let backgroundOpacity = 0.5;    
let bgWidth = null;  // NOUVEAU : Mémorise la largeur
let bgHeight = null; // NOUVEAU : Mémorise la hauteur

function loadBackgroundImage(input) {
    if (input.files && input.files[0]) {
        showToast("⏳ Chargement du plan...");
        const reader = new FileReader();
        reader.onload = function (e) {
            backgroundImageData = e.target.result;
            backgroundOpacity = 0.5; 
            bgWidth = null;  // Réinitialise la taille pour la nouvelle image
            bgHeight = null;
            applyBackgroundImage();
            saveState();
            showToast("🗺️ Fond de plan appliqué !");
        };
        reader.readAsDataURL(input.files[0]);
    }
    input.value = ""; 
...
function applyBackgroundImage() {
    ...
    if (!bgLayer) {
        // --- 1. Création de la couche d'image ---
        ...
        bgLayer.style.pointerEvents = "none"; // Ne bloque pas la souris pour pouvoir se déplacer
        container.insertBefore(bgLayer, container.firstChild);

        // --- 2. NOUVEAU : Création de la poignée d'agrandissement ---
        const resizeHandle = document.createElement("div");
        resizeHandle.id = "bg-resize-handle";
        resizeHandle.style.position = "absolute";
        resizeHandle.style.bottom = "-10px"; // Déborde un peu pour l'attraper facilement
        resizeHandle.style.right = "-10px";
        resizeHandle.style.width = "20px";
        resizeHandle.style.height = "20px";
        resizeHandle.style.backgroundColor = "#007AFF"; // Point bleu
        resizeHandle.style.border = "2px solid white";
        resizeHandle.style.borderRadius = "50%";
        resizeHandle.style.cursor = "nwse-resize"; // Curseur diagonale
        resizeHandle.style.pointerEvents = "all"; // IMPORTANT : Rend UNIQUEMENT ce point cliquable
        resizeHandle.style.boxShadow = "0 2px 5px rgba(0,0,0,0.3)";
        
        resizeHandle.addEventListener("mousedown", startBgResize);
        bgLayer.appendChild(resizeHandle);
    }

    if (backgroundImageData) {
        bgLayer.style.backgroundImage = `url(${backgroundImageData})`;
        bgLayer.style.backgroundRepeat = "no-repeat";
        bgLayer.style.backgroundSize = "100% 100%"; // S'étire avec la div
        bgLayer.style.opacity = backgroundOpacity;
        bgLayer.style.display = "block";
        
        // Si la taille n'est pas encore calculée, on prend la taille naturelle de l'image
        if (!bgWidth || !bgHeight) {
            const img = new Image();
            img.onload = function() {
                bgWidth = img.width;
                bgHeight = img.height;
                bgLayer.style.width = bgWidth + "px";
        ...
        if (slider) slider.value = backgroundOpacity;
    } else {
...
function updateBackgroundOpacity(val) {
    backgroundOpacity = parseFloat(val);
    const bgLayer = document.getElementById("bg-layer");
    if (bgLayer) bgLayer.style.opacity = backgroundOpacity;
}

function removeBackgroundImage() {
    if(confirm("Supprimer le fond de plan définitivement ?")) {
        backgroundImageData = null;
        bgWidth = null;
        bgHeight = null;
        applyBackgroundImage();
        saveState();
        showToast("🗑️ Fond de plan supprimé");
    }
}

/* --- LOGIQUE POUR AGRANDIR L'IMAGE À LA SOURIS --- */
...
function startBgResize(e) {
    e.stopPropagation(); // Empêche de bouger tout le plan de travail
    e.preventDefault();
    isResizingBg = true;
    
    const bgLayer = document.getElementById("bg-layer");
    bgStartWidth = bgLayer.offsetWidth;
    bgStartHeight = bgLayer.offsetHeight;
    bgResizeStartX = e.clientX;

    document.addEventListener("mousemove", onBgResize);
    document.addEventListener("mouseup", stopBgResize);
}
...
function onBgResize(e) {
    ...
    // Calcul du déplacement (corrigé par le niveau de zoom)
    const dx = (e.clientX - bgResizeStartX) / currentZoom;
    
    // On conserve les proportions (Ratio) pour ne pas écraser la carte
    const ratio = bgStartWidth / bgStartHeight;
    
    let newWidth = Math.max(200, bgStartWidth + dx); // Largeur minimum
...
function stopBgResize() {
    if (isResizingBg) {
        isResizingBg = false;
        document.removeEventListener("mousemove", onBgResize);
        document.removeEventListener("mouseup", stopBgResize);
        saveState(); // Sauvegarde la nouvelle taille
        markAsUnsaved();
    }
}